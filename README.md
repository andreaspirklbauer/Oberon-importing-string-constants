...
8. When code is generated involving an *imported* string, the export number (*exno*) stored in the field *x.a* is inserted in the code stream for later fixup by the module loader. This changes the following instructions in *ORG.loadStringAdr*
